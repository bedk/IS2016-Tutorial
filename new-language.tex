...
\begin{frame}{A Recipe for a New Language: Paraguayan Guaran\'{i}}{}
  \begin{itemize}
    \item Background on the langauge
...
\begin{frame}{Pronunciations of Spellings}{}
  ...
  \vfill
  In Guaran\'{i}, spellings are usually, but not always given with
...
\begin{frame}{Our Recipe}{}
  ...
  \item[Phonetic mixup] Train 3 successive models
    ...
    \end{enumerate}
    Each model trained with 20 iterations of Viterbi followed by 10
    iterations of forward-backward.
